...
image:http://maven.apache.org/images/maven-logo-black-on-white.png["kotlin-html-dsl", link="https://search.maven.org/beta/artifact/com.github.daggerok//daggerok-context/1.0.1/jar"]
